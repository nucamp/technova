...
echo "   • OpenObserve Console: http://localhost:5080"
echo "   • OpenVAS Console: http://localhost:9392"
echo ""
echo "🔑 Web App Quick Test Credentials:"
echo "   • Admin:   admin / admin123"
echo "   • Doctor:  dr.smith / doctor123"
echo "   • Patient: patient001 / password123"
echo ""
echo "🔑 OpenObserve Credentials:"
echo "   • Admin:   root@example.com / Complexpass#123"
echo ""
echo "🔑 OpenVAS Credentials:"
